...
import com.sulistyo.mypokemon.databinding.ActivityPokemonDetailBinding
import com.sulistyo.mypokemon.utils.*
import com.sulistyo.mypokemon.utils.DialogUtils.showFailedDialog
...
class PokemonDetailActivity : AppCompatActivity() {
    ...
    private lateinit var bind: ActivityPokemonDetailBinding

    private val viewModel: PokemonDetailViewModel by viewModel()

    private val pokemon: PokemonListEntry by bundleNonNull(EXTRA_POKEMON)

    private val customDialog = CustomProgressDialog()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityPokemonDetailBinding.inflate(layoutInflater)
    ...
    private fun initView(poke: Pokemon) {
        ...
        for (type in poke.types) {
            with(bind.ribbonRecyclerView) {
                addRibbon(
                    ribbonView(this@PokemonDetailActivity) {
    ...
    private fun catchPokemon(pokemon: PokemonListEntry) {
        ...
        Handler(Looper.getMainLooper()).postDelayed(
            {
                ...
                if (!isCatched()) {
                    ...
                    CustomDialogFragment(pokemon.imageUrl) {
                        savePokemon(it, pokemon)
    ...
    private fun savePokemon(nickname: String, pokemon: PokemonListEntry) {
        ...
        Toast.makeText(this, "$nickname Saved to MyPokemon", Toast.LENGTH_LONG).show()
    }
    ...
    companion object {
        ...
        fun startActivity(transformationLayout: TransformationLayout, pokemon: PokemonListEntry) =
            transformationLayout.context.intentOf<PokemonDetailActivity> {
